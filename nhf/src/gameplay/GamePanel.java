...
public class GamePanel extends OsPanel implements Runnable{
	 ...
	 */
	public PreviousMaps prevMaps = new PreviousMaps();
	/**
	...
	public BestRounds getPLayersScore() {
		return playersScoures;
	}
	...
	private void saveGameData() {
		...
		PreviousMaps.saveAllPreviousMaps(prevMaps, "source/save_file/last_save.txt");
		playersScoures.getCurrent().setPoint(gamer.getPoint());
		BestRounds.saveBests(playersScoures, "source/save_file/bestRounds.txt");
	}
	/**
	...
	public void loadGameData() {
		...
		this.prevMaps = PreviousMaps.loadALlPreviousMaps("source/save_file/last_save.txt");
		this.playersScoures = BestRounds.loadBests("source/save_file/bestRounds.txt");
